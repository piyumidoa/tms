                                ...
                                <div class="col-md-11">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="" name="txt_nic" id="txt_nic" onChange="loaddata(this.value);" maxlength="12" minlength="12" required>
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-group col-lg-6">
                                                    ...
                                                    <input type="date" id="f_dob" class="form-control datepicker reg_Date" id="txt_dob" name="txt_dob" placeholder="Date" data-date-format="yyyy-mm-dd" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="" name="txt_name" id="txt_name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" placeholder="" id="txt_unit" name="txt_dir_div" onChange="loadUnit(this.value,'1');">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" class="form-control" placeholder="" id="txt_tp" name="txt_tp">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="number" class="form-control" placeholder="" id="txt_mob" name="txt_mob">
                                            </div>
                                        </div>
                                       ...
                                       <!-- <div class="form-group">
                                           ...
                                           <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="" id="txt_email" name="txt_email">
                                            ...
                                            <!--
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">ෆැක්ස් </label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" placeholder="" id="txt_fax" name="txt_fax">
                                            </div>
                                        </div>
                                        -->
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success" id="saveEmp" name="saveEmp"/>
                                        ...
                                        <table class="table farmer_details_save_Table table-responsive" id="test">
                                            <thead>
                                                ...
                                                <!--    <th><input type="text" class="form-control" placeholder="TP" disabled name="etp"></th> -->
                                                    ...
                                                    <th><input type="text" class="form-control" placeholder="MOB" disabled name="eunit"></th>
...
*/
                                              ...
                                              echo "<td align='center'><a href='edit_employee.php?id=$eid'><img src='../../images/icons/edit.png' style='width: 25px; height: 25;' onclick='return confirm(`Do you want to edit the record`);' /></a>";
                                       if($usrole == 1) {
