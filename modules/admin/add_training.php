                                ...
                                <div class="col-md-11">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="txt_train" name="txt_train">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="place" name="place">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"> From </label>
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="from_date" name="from_date" type="date">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label"> To </label>
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="to_date" name="to_date" type="date">
                                            </div>
                                        </div>
                                        <!--
                                            <div class="form-group">                                            
                                        ...
                                        <div class="results"></div>
                                         ...
                                         -->
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success" id="saveEmp" name="addTrain"/>
                                        ...
                                        <table class="table farmer_details_save_Table table-responsive" id="test">
                                            <thead>
                                                <tr class="filters">
                                                    ...
                                                    <th><input type="text" class="form-control" placeholder="place" disabled name="place"></th>
                                                    <th><input type="text" class="form-control" placeholder="from" disabled name="from"></th>
                                                    <th><input type="text" class="form-control" placeholder="to" disabled name="to"></th>
