                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-16">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Unit Details</legend>                                                              
                                <div class="col-md-11">
                                    <div class="form-horizontal">
                                        <form name="emp_reg" id="emp_reg" method="POST" action="../../lib/admin_func.php">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="txt_unit" name="txt_unit" value="<?php echo $uname;?>" required="" list="unit_list">
                                                ...
                                                <datalist id="unit_list">                                             
                                                    ...
                                                    $sql = "SELECT DISTINCT * FROM tbl_unit;";
                                                    $result = mysqli_query($con,$sql);
                                                    $nor = $result->num_rows;
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" id="u_tel" name="u_tel" class="form-control" maxlength="10" min="10" value="<?php echo $utel;?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="results"></div>
                                         ...
                                         -->
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success" id="saveEmp" name="updateUnit"/>
                                        ...
                                        <table class="table farmer_details_save_Table table-responsive" id="test">
                                            <thead>
                                                <tr class="filters">
                                                    ...
                                                    <th><input type="text" class="form-control" placeholder="අධ්‍යක්ෂ අංශය" disabled name="enic"></th>
