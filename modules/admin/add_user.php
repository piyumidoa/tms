                                        ...
                                        <table class="table farmer_details_save_Table table-responsive" id="test">
                                          ...
                                          //    echo "<td>" . $row['post_name'] . "</td>";
                                           ...
                                           <a href='del_user.php?id=$uid'><img src='../../images/icons/delete.jpg' style='width: 25px; height: 25;' onclick='return confirm(`Do you want to delete the record`);'/></a></td>";
                                            ...
                                            //Going to first page
                                            echo "<center><a href='add_user.php?page=1' class='pagination'>"."First Page</a>";

                                            for ($i=1; $i<=$total_pages; $i++) {

                                            echo "<a  href='add_user.php?page=$i' class='pagination'>".$i."</a> ";
                                            };
                                            // Going to last page
                                            echo "<a href='add_user.php?page=$total_pages' class='pagination'>"."Last Page</a></center> ";
