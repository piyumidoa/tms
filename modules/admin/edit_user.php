...
<Doctype html>
    <head>
        ...
        <title> Register User | TMS for DOA</title>        
        <?php   
                                ...
                                <div class="col-md-11">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">                                             
                                                <input type="text" class="form-control chzn-select" name="txtemp_id" id="txtemp_id" 
                                                value="<?php if(isset($uid)) { echo $uid; } ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">                             
                                                <input type="password" class="form-control chzn-select" name="txtusr_pass" id="txtusr_pass"
                                                 onkeyup="CheckPasswordStrength(this.value);" placeholder="Please type password" 
                                                value="<?php if(isset($upass)) { echo $upass; } ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">                             
                                                <input type="password" class="form-control chzn-select" name="txtcon_pass" id="txtconf_pass" 
                                                onkeyup="checkPass(); return false;" placeholder="Please type password"
                                                value="<?php if(isset($upass)) { echo $upass; } ?>"/>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">                             
                                                <select id="selrole" name="selrole" class="form-control chzn-select">
                                                    ...
                                                    <option value="1" <?=$urole == '1' ? ' selected="selected"' : '';?> >Admin</option>
                                                    <option value="2" <?=$urole == '2' ? ' selected="selected"' : '';?> >User</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">                             
                                                    <input type="radio"  name="radusr_stat" id="radStat_a"  value="1" 
                                                    <?php if( isset($ustat)) { echo ($ustat=='1')?'checked':''; } ?> />
                                                    <label for="radStat_a">Active</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <input type="radio"  name="radusr_stat" id="radStat_i" value="0"
                                                    <?php if( isset($ustat)) { echo ($ustat=='0')?'checked':''; } ?> />
                                                    <label for="radStat_i">Inactive</label>
                                            </div>
                                        </div>
                                                                         
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success" id="saveEmp" name="editUser"/>
                                        ...
                                        <table class="table farmer_details_save_Table table-responsive" id="test">
                                          ...
                                          //    echo "<td>" . $row['post_name'] . "</td>";
                                           //   echo "<td>" . $row['unit_name'] . "</td>";
                                              ...
                                              echo "<td align='center'><a href='edit_user.php?id=$uid'><img src='../../images/icons/edit.png' style='width: 25px; height: 25;' onclick='return confirm(`Do you want to edit the record`);' /></a>
                                       
                                           <a href='del_user.php?id=$uid'><img src='../../images/icons/delete.jpg' style='width: 25px; height: 25;' onclick='return confirm(`Do you want to delete the record`);'/></a></td>";
