                                ...
                                <div class="col-md-11">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="" id="txt_post" name="txt_post">
                                        ...
                                        <div class="results"></div>
                                         ...
                                         -->
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-success" id="saveEmp" name="addPost"/>
