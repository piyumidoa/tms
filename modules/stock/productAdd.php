...
<div id="apDiv7">
 ...
 <div id="apDiv12" align="right"><a href="logout.php">Logout</a></div>
  ...
  <div id="apDiv6">
  <form action="productAddAction.php" onsubmit="return validate()">
    <table width="507" height="287" align="center">
      <tr>
        <td width="208">Product ID:<font color="#FF0000">*</font></td>
        <td colspan="2"><input type="text"  name="pID" id="pID" required="required"/></td>
      </tr>
      <tr>
        <td>Name:<font color="#FF0000">*</font></td>
        <td colspan="2"><input type="text"  name="name" id="name" size="50"required="required"/></td>
      </tr>
      <tr>
        <td height="90">Description:<font color="#FF0000">*</font></td>
        <td colspan="2"><textarea name="description" id="description" cols="45" rows="5" required="required"></textarea></td>
      </tr>
