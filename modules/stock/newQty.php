...
<div id="apDiv7">
  <p><samp class="mzg">
	...
	if(isset($_GET["msg"]))
	{
		...
		$status = "Error";
		if($msg=="Success")
			$status = "New quantity is updated Successfully ";
 ...
 <div id="apDiv12" align="right"><a href="logout.php">Logout</a></div>
  <p align="center"><strong>Add new quantity to stock</strong></p>
      </div>
  <div id="apDiv6">
  <form action="newQtyAction.php" method="post">
    <table width="507" height="120" align="center">
      <tr>
        <td width="208" height="56">Product ID:<font color="#FF0000">*</font></td>
        <td colspan="2"><select name="pid" id="pid" required="required">
	...
	?>
        ...
        <td height="27" >Add Quantity:<font color="#FF0000">*</font></td>
        <td colspan="2" ><p>
          <label for="qty"></label>
      ...
      <tr>
        ...
        <td width="128" bgcolor="#000000" ><a href="viewStock.php" target="_blank"><font color="#00CC33">View Stock</font></a></td>
      </tr>
    </table>
    </form>
  </div>
