 ...
 <tr><td width="4%" ></td>
	...
	<TABLE id="dataTable" border="0" style="width:90%">
		<TR>
			...
			<TD><INPUT type="text" name="txt_unit_name[]" /></TD>	
                        <TD><INPUT type="text" name="txt_dir_id[]" /></TD>
		</TR>
	</TABLE>                                              
</table> 
...
$con = $dbobj->getCon();
 ...
 //   $chkbox = $_POST['chk'];
    $uname = $_POST['txt_unit_name'];
    $did = $_POST['txt_dir_id'];

    foreach($uname as $a => $b)
    {    
        if($uname[$a]!=""){
 $sql2 = "INSERT INTO tbl_unit(unit_name, dir_div_id) VALUES ('$uname[$a]', '$did[$a]');";
