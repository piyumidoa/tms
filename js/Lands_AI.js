function loadAsc_ai_land_district(selected, callBack) {
...
//------------------------------------------------------------------------------------------------------
function loadAsc_ai_land_ds(selected, callBack) {
...
//------------------------------------------------------------------------------------------------------
function loadAsc_ai_land_gn(selected, callBack) {
...
//------------------------------------------------------------------------------------------------------
function loadCount_ai_land(selected) {    //load count
    //count=qry count+1
    var cou=1;
    var a=0;
...
function loadId_ai_land(selected, callBack) {  // get f_id
...
function saveLand1() {
    ...
    //alert("sdjaskldfhskd");
    if (id == '') {
        $.post("../views/view_Land_AI.php", {action: 'insert', key1: f_id, key2: l_id, key3: l_ext, key4: l_type, key5: l_owner, key6: plr_no, key7: s_type, key8: s_done, key9: s_date, key10: w_test, key11: w_date, key12: w_res, key13: irrigation, key14: flag_confirm, key15: flag_no_change, key16: email, key17: l_address, key18: district_id, key19: district, key20: dsdivi, key21: gndivi},
                function (e) {
                    alertifyMsgDisplay(e, 200);
                    acsRegistrationTable1(district_id,email);;
                    acsRegistrationTableDist1(district_id);
                    clearAcsReg_ai_land();
                }, "json");
    } else {
        $.post("../views/view_Land_AI.php", {action: 'update', key1: f_id, key2: l_id, key3: l_ext, key4: l_type, key5: l_owner, key6: plr_no, key7: s_type, key8: s_done, key9: s_date, key10: w_test, key11: w_date, key12: w_res, key13: irrigation, key14: flag_confirm, key15: flag_no_change, key16: l_address, key17: id, key18: district, key19: dsdivi, key20: gndivi},
                function (e) {
                    alertifyMsgDisplay(e, 200);
                    acsRegistrationTable1(district_id,email);
                    acsRegistrationTableDist1(district_id);
...
function acsRegistrationTable1(district_id,email) {
    //var tableData;
    //var deleteUserID;

    $.post("../views/view_Land_AI.php", {action: 'select', type: district_id, type1: email}, function (tableData) {
...
function acsRegistrationTableDist1(district_id) {
    //var tableData;
    //var deleteUserID;

        //$.post("../views/view_Land_AI.php", {action: 'select1', type: district_id}, function (tableData) {
...
//function acsRegistrationTable(district_id) {
//    //var tableData;
//    //var deleteUserID;
//
//    $.post("../views/view_Land_AI.php", {action: 'select', type: district_id}, function (tableData) {
//        if (tableData === undefined || tableData.length === 0 || tableData === null) {
//            $('.farmer_details_save_Table tbody').html(' -- No Data Found -- ');
//        } else {
//            $.each(tableData, function (index, tblValue) {
...
//                    alertify.confirm("Are you sure want to detele this record?", function (e) {
//                    if (e) {
//                        $.post("../views/view_Land_AI.php", {action: 'delete', dacs_f_id: res1, del: res2}, function (e) {
//                            acsRegistrationTable();
//                            alertifyMsgDisplay(e, 200);
//                            clearAcsReg();
//                        }, "json");
